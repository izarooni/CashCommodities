...
namespace MapleLib.MapleCryptoLib {
    ...
    public class CryptoConstants {
        ...
        /// </summary>
        public static byte[] WzAesBlock = new byte[128] { //16 * 8
        ...
        /// </summary>
        public static byte[] GetTrimmedUserKey(WzEncryption encryption = WzEncryption.GMS) {
            byte[] key = new byte[32];
            for (int i = 0; i < 128; i += 16) {
                key[i / 4] = encryption.GetAesBlock()[i];
            }
            return key;
        }
    }
